...
contract VIVA is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("ViceVersa Protocol", "VIVA", uint8(DECIMALS)) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Cake 
        ...
        autoLiquidityReceiver = 0x1f3e6E39298881054E4913C724CD3387982b5697;
        TreasuryReceiver = 0x8F63b370c6a78D7F92B55B9A7a6eCd147CC50480;
        RiskFreeValueReceiver = 0x2c6f308a8D7DD15A21EDAb0933e380E50a11fcfc;
